...
void MyRoomReport::draw() {
	...
	FontAsset(U"myroomsmallfont")(U"～Press to Enter～").drawAt(Scene::Width() / 2, Scene::Height() - 70, ColorF(0, 0, 0));
	FontAsset(U"myroomsmallfont")(U"～Press to Enter～").drawAt(Scene::Width() / 2, Scene::Height() - 70, AlphaF(alpha));
