...
void Title::draw(void) {
	...
	//タイトルのフォント
	FontAsset(U"titlefont")(U"～ Play ～").drawAt(Window::ClientWidth() *0.27, Window::ClientHeight() - 200 + 3, ColorF(0, 0, 0, alpha - 0.05));
	FontAsset(U"titlefont")(U"～ Play ～").drawAt(Window::ClientWidth() * 0.27, Window::ClientHeight() - 200, AlphaF(alpha));
}
